...
|---|---|---|
| Ganice Geralyn | Project Initiator | Membuat repository, mengatur akses kolaborator, commit `index.html` |
| Kevyn Adryan Liong | Styling Engineer | Membuat branch `styling`, menambahkan & menghubungkan `style.css` |
